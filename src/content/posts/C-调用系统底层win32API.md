...
draft: false
---
最近学习 C# 学到了本机互操作性，之前一直有需求需要调用 [Win32 API](https://link.zhihu.com/?target=https%3A//learn.microsoft.com/zh-cn/windows/win32/apiindex/windows-api-list)，查阅了许多资料踩了不少坑（如类型映射、封送结构等），现在整理出一套调用 Win32 API 的方法，因此记录一下顺便分享给大家参考。
